...
"QPushButton:pressed{background-color:rgb(255, 91, 58);}")
        ...
        palette5 = QPalette()
        brush7 = QBrush(QColor(22, 22, 22, 255))
        ...
        self.menuBeamStatus.setFont(font4)
