...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.PV_name_txt_2 = QLineEdit(Form)
        self.PV_name_txt_2.setObjectName(u"PV_name_txt_2")
        self.PV_name_txt_2.setMinimumSize(QSize(260, 40))
        self.PV_name_txt_2.setMaximumSize(QSize(16777215, 40))
        palette = QPalette()
        ...
        self.PV_name_txt_2.setPalette(palette)
        font = QFont()
        font.setFamilies([u"Cambria"])
        font.setPointSize(14)
        font.setBold(True)
        self.PV_name_txt_2.setFont(font)
        self.PV_name_txt_2.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_2.addWidget(self.PV_name_txt_2)
...
"QPushButton:pressed{background-color:rgb(255, 91, 58);}")
        ...
        self.Instrument_txt.setPalette(palette6)
        ...
        self.PV_alisa_txt = QLineEdit(Form)
        self.PV_alisa_txt.setObjectName(u"PV_alisa_txt")
        self.PV_alisa_txt.setMinimumSize(QSize(260, 40))
        self.PV_alisa_txt.setMaximumSize(QSize(16777215, 40))
        palette7 = QPalette()
        ...
        self.PV_alisa_txt.setPalette(palette7)
        self.PV_alisa_txt.setFont(font)
        self.PV_alisa_txt.setAlignment(Qt.AlignCenter)

        self.verticalLayout_2.addWidget(self.PV_alisa_txt)
        ...
        self.PV_name_txt.setPalette(palette8)
...
"QPushButton:pressed{background-color:rgb(255, 91, 58);}")
    ...
    def retranslateUi(self, Form):
        ...
        self.PV_name_txt_2.setText("")
        self.PV_name_txt_2.setPlaceholderText(QCoreApplication.translate("Form", u"XML file with PV names", None))
        ...
        self.PV_alisa_txt.setText("")
        self.PV_alisa_txt.setPlaceholderText(QCoreApplication.translate("Form", u"Alias for PV name", None))
