...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionEset = QAction(MainWindow)
        self.actionEset.setObjectName(u"actionEset")
        self.action20U_2 = QAction(MainWindow)
        self.action20U_2.setObjectName(u"action20U_2")
        self.actionLoadBeamline = QAction(MainWindow)
        self.actionLoadBeamline.setObjectName(u"actionLoadBeamline")
...
"QPushButton:pressed{background-color:rgb(255, 91, 58);}")
        ...
        self.PV_mdi.setFrameShape(QFrame.Box)
        self.PV_mdi.setFrameShadow(QFrame.Sunken)
        brush5 = QBrush(QColor(76, 200, 231, 255))
        brush5.setStyle(Qt.Dense4Pattern)
        self.PV_mdi.setBackground(brush5)
        self.PV_mdi.setViewMode(QMdiArea.SubWindowView)
        self.PV_mdi.setDocumentMode(True)
        self.PV_mdi.setTabsMovable(False)
        self.PV_mdi.setTabShape(QTabWidget.Rounded)
        ...
        palette4 = QPalette()
        brush6 = QBrush(QColor(255, 77, 23, 255))
        ...
        self.menuPVTree.setFont(font3)
        self.menu20U = QMenu(self.menuPVTree)
        self.menu20U.setObjectName(u"menu20U")
        self.menuPGM1 = QMenu(self.menu20U)
        self.menuPGM1.setObjectName(u"menuPGM1")
        ...
        self.menuBeamStatus.setFont(font3)
        ...
        self.menuMenu.addAction(self.actionLoadBeamline)
        self.menuPVTree.addAction(self.menu20U.menuAction())
        self.menu20U.addAction(self.menuPGM1.menuAction())
        self.menuPGM1.addAction(self.actionEset)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionEset.setText(QCoreApplication.translate("MainWindow", u"Eset", None))
        self.action20U_2.setText(QCoreApplication.translate("MainWindow", u"20U", None))
        self.actionLoadBeamline.setText(QCoreApplication.translate("MainWindow", u"LoadPVs", None))
        ...
        self.menu20U.setTitle(QCoreApplication.translate("MainWindow", u"20U", None))
        self.menuPGM1.setTitle(QCoreApplication.translate("MainWindow", u"PGM1", None))
